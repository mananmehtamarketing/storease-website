        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <img src="/logo.png" alt="Storease" width={32} height={32} className="w-8 h-8" />
              <span className="text-lg font-extrabold tracking-[0.12em] text-white uppercase">STOREASE</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link href="/live-events" className="text-gray-400 hover:text-[#F5A623] text-sm transition-colors">Live Events</Link></li>
